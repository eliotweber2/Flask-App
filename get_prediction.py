...
def predict(video_path, user_id):
    ...
    attention_model.load_weights('model/attention_model_weights.h5')
    ...
    cnn_model.load_weights('model/cnn_lstm_model_weights.h5')
    ...
    transformer_model.load_weights('model/transformer_model_weights.h5')
